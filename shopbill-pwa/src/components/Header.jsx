...
const Header = ({ 
    ...
    setCurrentPage,
    currentPage,
    notifications = [], // Receive notifications as a prop from App.js
    onLogout, 
    apiClient,  
    API         
}) => {
    
    // The count is simply the length of our notifications array
    const notificationCount = notifications.length;

    // Common classes for action buttons
        ...
        >
            ...
            <div className="flex space-x-3 items-center">
                ...
                >
                    ...
                    {notificationCount > 0 && (
                        <span className="absolute top-0 right-0 block h-5 w-5 rounded-full ring-2 ring-white dark:ring-gray-900 bg-red-600 text-white text-[10px] font-bold flex items-center justify-center transform translate-x-1 -translate-y-1.5">
