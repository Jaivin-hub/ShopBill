                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input type="date" value={purchaseForm.date} onChange={(e) => setPurchaseForm({ ...purchaseForm, date: e.target.value })} className={`w-full ${inputBase} px-4 py-3 rounded-xl outline-none text-[10px] font-bold box-border`} />
                    </div>
                  </div>
                </div>
