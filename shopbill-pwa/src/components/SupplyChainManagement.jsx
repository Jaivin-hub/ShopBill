      ...
      <header className={`sticky top-0 z-[100] ${darkMode ? 'bg-gray-950 border-gray-800/50' : 'bg-white border-slate-200 shadow-sm'} border-b px-4 md:px-8 py-4`}>
        <div className="max-w-screen-2xl mx-auto flex justify-between items-center">
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-gray-500 font-bold  tracking-widest mt-1.5">Manage stock arrivals</p>
          </div>
              ...
              <form onSubmit={handlePurchaseSubmit} className={`${cardBase} rounded-2xl p-6 space-y-6`}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[9px] font-black text-gray-500  tracking-widest ml-1">Date</label>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <select
                        ...
                        className={`${darkMode ? 'bg-gray-950 border-gray-800' : 'bg-white border-slate-200 shadow-sm'} text-[9px] font-black  text-indigo-400 px-2 py-1 rounded-lg outline-none cursor-pointer`}
                      >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 shrink-0">
              {[
                ...
                <div key={i} className={`${darkMode ? 'bg-gray-900/50 border-gray-800 group hover:bg-gray-900' : 'bg-white border-slate-200 group hover:bg-slate-50'} border p-4 rounded-xl flex flex-col items-center text-center transition-all shadow-sm`}>
                  ...
                  <p className="text-[8px] font-black text-gray-600  tracking-widest mb-1">{stat.label}</p>
                ...
                <table className="w-full text-left min-w-[700px]">
                  <thead
                    className={`sticky top-0 z-10 ${darkMode ? 'bg-gray-900' : 'bg-slate-100'
                      } text-[9px] font-black text-gray-500  tracking-widest border-b ${darkMode ? 'border-gray-800' : 'border-slate-200'
                      }`}
                  >
                    <tr>
        ...
        {activeTab === 'suppliers' && (
          <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex justify-end items-center pb-2">
              <button onClick={() => setIsSupplierModalOpen(true)} className={`${darkMode ? 'bg-white text-black hover:bg-gray-200' : 'bg-slate-900 text-white hover:bg-slate-800'} px-5 py-2 rounded-xl text-[10px] font-black  transition-all active:scale-95 shadow-xl flex items-center gap-2`}>
